          ...
          <div key={i} className="border border-gray-200 rounded-xl p-5 bg-gray-50 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1 block">
                ...
                <input value={phd.scholarName} onChange={e => set(i, 'scholarName', e.target.value)} className={ic(i, 'scholarName')} />
              ...
              <div className="space-y-1 block">
                ...
                <input value={phd.universityInstitute} onChange={e => set(i, 'universityInstitute', e.target.value)} className={ic(i, 'universityInstitute')} />
            ...
            <div className="space-y-1 block">
              ...
              <input value={phd.researchTopic} onChange={e => set(i, 'researchTopic', e.target.value)} className={ic(i, 'researchTopic')} placeholder="Full thesis/research topic" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1 block">
                ...
                <input value={phd.supervisors} onChange={e => set(i, 'supervisors', e.target.value)} className={ic(i, 'supervisors')} placeholder="All supervisor names" />
              ...
              <div className="flex items-end gap-4 pb-2">
                ...
                <div className="space-y-1 flex-1 block">
                  ...
                  <input type="number" min={0} value={phd.coSupervisorCount} onChange={e => set(i, 'coSupervisorCount', parseInt(e.target.value) || 0)} className={ic(i, 'coSupervisorCount')} />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1 block">
                ...
                <input value={phd.year} onChange={e => set(i, 'year', e.target.value.replace(/\D/g, '').slice(0, 4))} className={ic(i, 'year')} maxLength={4} placeholder="YYYY" />
                {errText(i, 'year')}
              </div>
              <div className="space-y-1 block">
                ...
                <select value={phd.status} onChange={e => set(i, 'status', e.target.value)} className={ic(i, 'status')}>
