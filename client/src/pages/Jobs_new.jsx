...
const Jobs = () => {
  ...
  const [advertisementNo, setAdvertisementNo] = useState(searchParams.get('advertisementNo') || '');
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      try {
        ...
        if (advertisementNo) params.advertisementNo = advertisementNo;
    ...
    fetchJobs();
  }, [searchTerm, advertisementNo, designation, department, page]);
        ...
        <form onSubmit={handleSearch} className="flex flex-col lg:flex-row gap-4 mb-8">
          ...
          <div className="flex-shrink-0 relative">
            ...
            <input
              ...
              onChange={(e) => { setAdvertisementNo(e.target.value); setPage(1); }}
