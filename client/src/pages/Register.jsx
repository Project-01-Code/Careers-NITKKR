            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="space-y-1.5 col-span-2 sm:col-span-1">
                  ...
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-xl pointer-events-none transition-colors">call</span>
                    <input
                      type="tel"
                      value={phone}
                      onChange={(e) => {
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all bg-white/50 text-sm"
                      required
                    />
                  </div>
                </div>
